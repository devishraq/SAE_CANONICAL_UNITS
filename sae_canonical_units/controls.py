...
def shuffled_decoder_control(sae_small, sae_large, acts, thresh=0.7):
    ...
    perm = torch.randperm(sae_large.W_dec.shape[1])
    W_shuf = sae_large.W_dec[:, perm].clone()
    sae_large_shuf = copy.deepcopy(sae_large)
    sae_large_shuf.W_dec.data = W_shuf
    ...
    return {
        ...
        "note": "Shuffled should give 100% geo, 10.5% func"
    }
